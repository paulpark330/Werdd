...
struct Werdds {
    var data: [Werdd] = [
        ...
        Werdd(name: "Mauve", partOfSpeech: "noun", definition: "a moderate purple, violet, or lilac color one of two poles each with a rest or strap for the foot used to elevate the wearer above the ground in walking one of two poles each with a rest or strap for the foot used to elevate the wearer above the ground in walking"),
